...
@section('title', 'Ramonak | edit contact title')

@section('section_title', 'Edit contact title')
...
<div class="form-group">
  ...
  <br>
  <br>
  <button  class="btn btn-primary btn-lg bt n-block" type="submit">Save new contact</button>
</form>
